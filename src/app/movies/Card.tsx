...
const Card: React.FC<Props> = ({ movie }) => {
    ...
    return <StyledCard data-testid="movie-card">
        <Content>
            {movie.id}
        ...
        <Button data-testid="open-modal-button" onClick={() => setModalOpen(true)}>Show details</Button>

        {isModalOpen && <MovieModal movie={movie} onClose={() => setModalOpen(false)} />}
    </StyledCard>
}
